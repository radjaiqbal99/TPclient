                ...
                <div class="card" style="">
                  ...
                  >
                    ...
                    <Column
                      ...
                      style="width: 6rem"
                    ></Column>
                    <Column field="upah" header="Upah" :sortable="true"
...
export default defineComponent({
  setup() {
    ...
    const items = ref([{ label: "Upah Pegawai", to: "/upahPegawai" }]);
    ...
    const saveProduct = async () => {
      ...
      if (product.value.satuan.trim()) {
        if (product.value.id) {
          await ApiPegawai.value
            .editUpahPegawai(product.value.id, product.value)
            .then(async () => {
    ...
    const deleteProduct = (prod, event) => {
      ...
      confirm.require({
        ...
        accept: async () => {
          await ApiPegawai.value
            .deleteUpahPegawai(product.value.id)
            .then(async () => {
