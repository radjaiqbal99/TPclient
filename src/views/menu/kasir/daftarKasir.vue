            ...
            <div class="row row-deck row-cards">
              ...
              <div class="col-12">
                <div class="card" style="">
                  <DataTable
                    ...
                    filterDisplay="menu"
                    :loading="loading1"
                    :globalFilterFields="['id', 'name', 'username', 'password']"
                  >
                    <!-- <template #header>
              ...
              >
                <div class="p-field mb-2">
                  ...
                  >
                  <label for="name" class="mb-2 mt-2">Username</label>
                  <InputText
                    id="username"
                  ...
                  <small
                    class="p-error d-block"
                    v-if="submitted && !product.username"
                    >Username is required.</small
                  >
                  <label for="name" class="mb-2 mt-2">Password</label>
                  <InputText
                    id="password"
                    :autoResize="true"
                  ...
                  <small
                    class="p-error d-block"
                    v-if="submitted && !product.password"
...
<script>
import apiKasir from "../../../service/Api";
...
export default defineComponent({
  setup() {
    ...
    const saveProduct = async () => {
      ...
      if (product.value.name.trim()) {
        if (product.value.id) {
          await ApiKasir.value
            .editKasir(product.value.id, product.value)
            .then(async () => {
  ...
  // mounted() {
  //   //API Call
  //   axios.get("http://127.0.0.1:8000/api/daftarKasir").then((res) => {
