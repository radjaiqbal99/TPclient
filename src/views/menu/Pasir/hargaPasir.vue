            ...
            <div class="row row-deck row-cards">
              ...
              <div class="col-12">
                <div class="card" style="">
                  <DataTable
                    ...
                    filterDisplay="menu"
                    :loading="loading1"
                    :globalFilterFields="['jumlah','harga']"
                  >
                    <!-- <template #header>
              ...
              >
                <div class="confirmation-content">
                  ...
                  />
                  <span v-if="product"
                    >Are you sure you want to delete <b>{{ product.jumlah }}</b
                    >?</span
                  >
                </div>
                <template #footer>
...
<script>
import apiHargaPasir from "/src/service/Api";
  ...
  setup() {
    ...
    const saveProduct = async () => {
      ...
      if (product.value.jumlah.trim()) {
        if (product.value.id) {
          await ApiHargaPasir.value
            .editHargaPasir(product.value.id, product.value)
            .then(async () => {
              ...
              toast.add({
                severity: "success",
                summary: "Ubah data",
                detail: `Berhasil mengubah ( ${product.value.jumlah} )`,
                life: 3000,
              });
              //==============================
              await ApiHargaPasir.value
            ...
            .catch((err) => {
              ...
              toast.add({
                severity: "error",
                summary: "Gagal",
                detail: `Gagal mengubah ( ${product.value.jumlah} )`,
                life: 3000,
              });
            });
          product.value = {};
          ...
          await ApiHargaPasir.value
            .addHargaPasir(product.value)
            .then(async () => {
              add.value = false;
              toast.add({
                severity: "success",
                summary: "Tambah Data",
                detail: `Berhasil menambahkan ( ${product.value.jumlah} )`,
                life: 3000,
              });
              await ApiHargaPasir.value
                .getHargaPasir()
            ...
            .catch((err) => {
              ...
              toast.add({
                severity: "error",
                summary: "Failed",
                detail: `Gagal menambahkan ( ${product.value.jumlah} )`,
                life: 3000,
              });
            });
          product.value = {};
    ...
    const deleteProduct = (prod, event) => {
      ...
      confirm.require({
        ...
        accept: async () => {
          await ApiHargaPasir.value
            .deleteHargaPasir(product.value.id)
            .then(async () => {
              deleteProductDialog.value = false;
              toast.add({
                severity: "success",
                summary: "Berhasil",
                detail: `Berhasil menghapus ( ${product.value.jumlah} )`,
                life: 3000,
              });
              product.value = {};
              await ApiHargaPasir.value
            ...
            .catch((err) => {
              ...
              toast.add({
                severity: "error",
                summary: "Gagal",
                detail: `Gagal menghapus ( ${product.value.jumlah} )`,
                life: 3000,
              });
              product.value = {};
