                        ...
                        >
                          ...
                          >
                            <template #body="slotProps">
                              <Badge
                                v-if="slotProps.data.transaksi === 'Deposit'"
                                v-bind:value="slotProps.data.transaksi"
                                severity="success"
                                class=""
                              ></Badge>
                              <Badge
                                v-if="slotProps.data.transaksi === 'Credit'"
                                v-bind:value="slotProps.data.transaksi"
                                severity="warning"
                                class=""
                              ></Badge></template
                          ...
                          <Column
                            ...
                            sortable
                          ></Column>
                          <Column field="nominal" header="Jumlah" sortable>
                            <template #body="slotProps" sortable>
                              Rp {{ formatCurrency(slotProps.data.nominal) }}
                            </template>
                          </Column>
                        </DataTable>
                      </div>
...
export default defineComponent({
  setup() {
    ...
    const items = ref([{ label: "Dompet Pegawai", to: "/dompetPegawai" }]);
