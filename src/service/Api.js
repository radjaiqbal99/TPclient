...
export default class Api {
    ...
    //pencatatan
    getPencatatan() {
        return axios.get(`https://server.natunasandmine.com/api/pencatatan`)
    }
    addPencatatan(value) {
        return axios.post(`https://server.natunasandmine.com/api/pencatatan`, value)
    }
    deletePencatatan(value) {
        return axios.post(`https://server.natunasandmine.com/api/pencatatanDelete`, value)
    }
    //BON Truk
    getBon() {
        return axios.get(`https://server.natunasandmine.com/api/bon`)
    }

    //Dashboard
    getDashboard() {
        return axios.get(`https://server.natunasandmine.com/api/dashboard`)
    }
    //new Password
    sendPassword(value) {
        return axios.post(`https://server.natunasandmine.com/api/resetPassword`,value)
    }
}